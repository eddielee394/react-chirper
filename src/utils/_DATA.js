let users = {
  janedoe: {
    id: "janedoe",
    name: "Jane Doe",
    avatarURL: "http://i.pravatar.cc/50?img=48",
    tweets: [
  ...
  joeschmoe: {
    id: "joeschmoe",
    name: "Joe Schmoe",
    avatarURL: "http://i.pravatar.cc/50?img=50",
    tweets: [
  ...
  johnfoo: {
    id: "johnfoo",
    name: "John Foo",
    avatarURL: "http://i.pravatar.cc/50?img=22",
    tweets: [
